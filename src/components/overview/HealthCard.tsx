    ...
    >
      <View className="flex-row items-center gap-3 mb-3">
        ...
        <View className="flex-1">
          ...
          {subtitle && <Text className="text-xs text-gray-400 dark:text-gray-500">{subtitle}</Text>}
        </View>
        {rightContent}
      ...
      <View className="flex-row gap-2">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <Text className="text-[9px] text-gray-400 dark:text-gray-500 uppercase tracking-wider mt-0.5">
              {stat.label}
            </Text>
          </View>
        ))}
